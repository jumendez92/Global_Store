...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title">
    	  <h1><a href="indexrevisorcontenido.php">   </a></h1>
    	</div>
        <div id="header_right">
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="indexrevisorcontenido.php" class="selected">Home</a></li>
                <li><a>Products</a>
                    <ul>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                    	<li class="first"><a href="buscar.php">Search Content</a></li>
                        <li class="last"><a href="#">Modify Content</a></li></li>
                    </ul>
                </div>
            </div>
