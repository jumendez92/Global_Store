...
<form method="post" id="adminForm" name="userForm"  class="form-validate">
			...
			<div align="center">
		<p>Register Employee <a href="registroempleado.php">here</a> </p>
        <p>
		  <label>Modify Employee<a href="/GlobalStore/registropelicula.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>Delete Employee<a href="/GlobalStore/registromusica.php"> here<br />
		  </a></label>
		</p>
        <p>
		</p>
              <p>
                <label>Back <a href="indexadministradorsistema.php">here</a></a></label>
              </p>
</div> 
    	</div>
