...
<title>Global Store - Register</title>
...
<form method="post" name="userForm"  class="form-validate" action="registrar.php">
			...
			<div align="center">
              ...
              <table align="center"  >
					...
					<td class="key" title="" ><label for="username_field" class="username"> Username*</label></td>
					<td>
						<input name="username" type="text" required="required" id="username_field" value="" size="30"  maxlength="25" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" ><label for="password_field2" class="password"> Password*</label></td>
					<td>
						<input name="password" type="password" required="required" class="inputbox" id="password_field" size="30" />
					</td>
				</tr>
					<tr>
					<td class="key" title="" ><label for="password2_field2" class="password2"> Confirm Password*</label></td>
					<td>
						<input name="password2" type="password" required="required" class="inputbox" id="password2_field" size="30" />
					</td>
				</tr>
                <tr>
                <td class="key" title="" ><label for="username_field" class="username"> ID*</label></td>
					<td>
						<input name="id" type="number" required="required" id="username_field" min="0" max="1000000000" value=""   /> 					</td>
				</tr>
                <td class="key" title="" >
					...
					<td>
						<input name="email" type="text" required="required"  class="required" id="email_field" value="" size="30" maxlength="100" /> 					</td>
				</tr>
    <tr>
      <td class="key" title="" >
    ...
    <option value="Viudo">Widower</option>
					...
					<td>
						<input name="first_name" type="text" required="required"  class="required" id="first_name_field" value="" size="30" maxlength="32" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
					...
					<td>
						<input name="last_name" type="text" required="required"  class="required" id="last_name_field" value="" size="30" maxlength="32" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
						<label class="last_name" for="last_name_field">
					...
					<td>
						<input type="text" id="last_name_field" name="second_last_name" size="30" value=""  class="required" maxlength="32" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" >
	...
	<option value="Zimbabwe">Zimbabwe</option>
					...
					<td>
						<input name="phone_1" type="number" required="required" id="phone_1_field" max="10000000000" min="00000000000" value="" size="30"  maxlength="32" /></td>
				</tr>
            ...
            <td align="center"> <p>&nbsp;
              ...
              <p>
                <label>After registering please Login</label>
              <p>
