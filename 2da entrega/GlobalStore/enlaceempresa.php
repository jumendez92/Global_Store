...
<title>Global Store - Company</title>
...
<br />
<h2>Select Developer Company or Person</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="modificarempper.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Developer Company or Person*</label></td>
					<td>
                <?php include ("conexion.php");
				$result = pg_query($conexion , "select nombre_empresa_persona from EMPRESA_PERSONA" );
			?>
                	<select name="empresaperso"  >
                	 <option value="">-Select-</option>
                        <?php
						while ($fila2= pg_fetch_row($result)){ 
                    	?>
                        <option value="<?php echo $fila2[0];?>"><?php echo $fila2[0];?></option>
                    	<?php
