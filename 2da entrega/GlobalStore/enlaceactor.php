...
<form method="post" id="adminForm" name="userForm"  class="form-validate">
			...
			<div align="center">
		<p>
		  <label>Want to add more actor or director click<a href="/GlobalStore/registroactor.php"> here</a></label>
		</p>
              <p>
                <label>To add more image or video click <a href="/GlobalStore/registroimaginesovideos.php">here</a></label>
              </p>
</div> 
    	</div>
