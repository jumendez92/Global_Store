...
<form method="post" id="adminForm" class="form-validate"action="registrarE.php">
      ...
      <td class="key" title="" >
        ...
        <td>
                ...
                <tr>
					...
					<td>
						<input name="phone_1" type="number" id="phone_1_field" max="1000000000000" min="0" value="" size="30"  maxlength="32" /> 					</td>
				</tr>
