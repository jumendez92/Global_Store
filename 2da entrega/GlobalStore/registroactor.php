...
<title>Global Store - Register Actor</title>
...
<br />
<h2>Register Actor or Director</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registroactordirector.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Name*</label></td>
					<td>
                      <input name="name2" type="text" required="required" id="textfield" /></td>
				      
					</tr>
                    <tr>
                <tr>
					<td class="key" title="" ><label for="name_field" class="name">Last Name*</label></td>
					<td>
                      <input name="lastname" type="text" required="required" id="textfield" /></td>
				      
					</tr>
                    <tr>
					<td class="key" title="" >
						<label class="title" for="title_field">
							Actor or Director*						</label>
					</td>
					<td>
