...
<title>Global Store - Empleado</title>
...
<br />
<h2>Select Employee to modify</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="modificaremple.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Username Employee*</label></td>
					<td>
                <?php include ("conexion.php");
				$result = pg_query($conexion , "select usuario_persona from PERSONA where tipo_persona='Empleado'" );
			?>
                	<select name="usuarioemple"  >
