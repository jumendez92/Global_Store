...
<title>Global Store - Register Version Operating System</title>
...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title">
    	  <h1><a href="indexadministradorsistema.php"></a></h1></div>
        <div id="header_right">
        	<p>&nbsp;</p>
            <p>&nbsp;</p>
		</div>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="indexadministradorsistema.php">Home</a></li>
                <li><a>Products</a>
                    <ul>
...
<br />
<h2>Register Version Operating System</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<td class="key" title="" ><label for="name_field" class="name">Operating System Name*</label></td>
					<td>
						<input name="name" type="text" required="required" id="name_field" value="" size="30"  maxlength="25" /> 					</td>
				</tr>
                <tr>
                <td class="key" title="" ><label for="username_field" class="username">Name of the Version*</label></td>
					<td>
