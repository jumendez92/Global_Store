...
<title>Global Store - Register Category</title>
...
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registrocat.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Category*</label></td>
					<td>
