...
<form method="post" id="adminForm" name="userForm"  class="form-validate">
			...
			<div align="center">
		<p>
		  <label>Want to add more images or videos click<a href="/GlobalStore/registroimaginesovideos.php"> here</a></label>
		</p>
              <p>
                <label>To finish the register click <a href="/GlobalStore/indexadministradorsistema.php">here</a></label>
              </p>
</div> 
    	</div>
