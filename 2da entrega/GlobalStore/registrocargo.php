...
<title>Global Store - Register Office</title>
...
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registrocar.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Office*</label></td>
					<td>
                      <input name="name" type="text" required="required" id="textfield" /></td>
				      
					</tr>
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Salary*</label></td>
					<td>
                      <input name="salary" type="number" required="required" id="textfield" min="0" /></td>
