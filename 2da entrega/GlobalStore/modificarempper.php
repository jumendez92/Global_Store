...
<br />
<h2>Modify <span class="email">Developer Company or Person </span></h2>
<?php
include ("conexion.php");
session_start();
$user=$_POST['empresaperso'];

$result=pg_query($conexion,"select id_empresa_persona,sitio_web_empresa_persona from EMPRESA_PERSONA where nombre_empresa_persona='$user'");

$row0=pg_fetch_row($result);
...
$result01=pg_query($conexion,"select FK_LUGAR from EMPRESA_PERSONA where id_empresa_persona=$row0[0]");
...
?>
<form method="post" id="adminForm" class="form-validate"action="modifyempresapersona.php">
  ...
  <table  class="adminForm user-details">
					...
					<td>
						<input type="text" id="username_field" name="namecompany" size="30" value="<?php echo $user?>"  maxlength="25" /> 					</td>
				</tr>
    ...
    <tr>
					...
					<td>
                      <input name="url" type="url"  id="url" value="<?php echo $row0[1]?>" />
						</td>
				</tr>
                <tr>
	...
	<option value="Persona">Person</option>
					...
					<td>
						<input name="address_2" type="text" required="required" id="address_2_field" value="<?php echo $row3[0]?>" size="30"  maxlength="64" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
					...
					<td>
					  <input name="address_3" type="text" required="required" id="address_2_field" value="<?php echo $row5[0]?>" size="30"  maxlength="64" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" >
