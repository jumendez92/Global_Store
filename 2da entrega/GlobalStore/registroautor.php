...
<title>Global Store - Register Autor</title>
...
<br />
<h2>Register Autor</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registroau.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<td>
                      <input type="text" name="name2" id="textfield" /></td>
				      
					</tr>
                    	<tr>
       <td class="key" title="" >
      
		<label for="date">Review*               </label> </td>
        <td>
