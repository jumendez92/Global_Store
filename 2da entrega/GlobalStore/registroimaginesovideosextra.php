...
<title>Global Store - Register Images & Videos</title>
...
<br />
<h2>Register Images &amp; Videos</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registroimages.php" enctype="multipart/form-data">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
                   <tr>
                <td class="key" title="" ><label for="name_field" class="name">App or Movie Name*</label></td>
					<td>
              <input name="name" type="text" required="required" id="textfield" /></td>
					
	</tr>
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Image</label></td>
					<td>
                      <input name="imagen" type="file" id="fileField"  /></td>
				      
					</tr>
                    <tr>
                <td class="key" title="" ><label for="name_field" class="name">Url Video</label></td>
					<td>
              <input name="url" type="url" id="url" /></td>
