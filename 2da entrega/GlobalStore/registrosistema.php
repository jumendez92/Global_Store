...
<title>Global Store - Register System</title>
...
<br />
<h2>Register Operating System</h2>
<form method="post" id="adminForm" name="userForm" class="form-validate" action="registrarS.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<td class="key" title="" ><label for="username_field" class="username">Operating System Name*</label></td>
					<td>
						<input name="username" type="text" required="required" id="username_field" value="" size="30"  maxlength="25" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" ><label for="estadocivil_field2" class="estadocivil"> Type Operating System*</label></td>
					<td>
						<select name="title" required="required" class="vm-chzn-select" id="title">
    <option value="">-Select-</option>
	<option value="Propietario">Closed</option>
	<option value="Codigo Abierto">Open Source</option>
      ...
      <td class="key" title="" >
        ...
        <td>
                        ...
                        <input name="date" type="date" required="required" id="date" max="2015-12-31" min="1980-01-31" />
                        </td>
                        <tr>
       <td class="key" title="" >
      
		<label for="date">Features*               </label> </td>
        <td>
