...
<title>Global Store - Register Music</title>
...
<form method="post" id="adminForm" class="form-validate"action="registrarM.php" enctype="multipart/form-data">
  ...
  <table  class="adminForm user-details">
                    		<tr>
					<td class="key" title="" >Disc Name*</td>
					<td>
						<input type="text" id="username_field" name="musicname" size="30" value=""  maxlength="25" /> 					</td>
				</tr>
                ...
                <tr>
					...
					<td>
						<input type="text" id="company_field" name="singer" size="30" value=""  class="required" maxlength="100" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
						<label class="email" for="email_field">
					  Singer Last Name*						</label>
					</td>
					<td>
						<input type="text" id="company_field" name="singerlastname" size="30" value=""  class="required" maxlength="100" /> 					</td>
				</tr>
    <tr>
      <td class="key" title="" >
      
		<label for="date"> Production Date*               </label> </td>
        <td>
					...
					<td class="key" title="" >
					  ...
					  Number of Songs*						</label>
					</td>
					<td>
						<input name="songs" type="number" id="middle_name_field" min="0" value="" size="10"  maxlength="32" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" >
					...
					<td>
						<input type="text" id="last_name_field" name="genre" size="30" value=""  class="required" maxlength="32" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
						<label class="last_name" for="last_name_field">
					...
					<td>
					  <input type="text" id="last_name_field" name="label" size="30" value=""  class="required" maxlength="32" /> 					</td>
				</tr>
	<tr>
					<td class="key" title="" >
					...
					<td>
                        ...
                        <option value="atrac">atrac</option>
