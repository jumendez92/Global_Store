...
<title>Global Store - Choice</title>
...
<form method="post" id="adminForm" name="userForm"  class="form-validate">
			...
			<div align="center">
		<p>
		  <label>Register App<a href="/GlobalStore/enlanceaplicacion.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>Register Movie<a href="/GlobalStore/registropelicula.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>Register Music<a href="/GlobalStore/registromusica.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>Register Book<a href="/GlobalStore/registrolibro.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>Search<a href="/GlobalStore/buscar.php"> here<br />
		  </a></label>
		</p>
              <p>
                <label>To finish the register click <a href="<?php echo $_SERVER['HTTP_REFERER']; ?>"> here</a></label>
              </p>
</div> 
    	</div>
