...
<title>Global Store - Register Book</title>
...
<br />
<h2>Register Book</h2>
<form method="post" id="adminForm" class="form-validate"action="registroL.php" enctype="multipart/form-data">
  ...
  <table  class="adminForm user-details">
                    		<tr>
					<td class="key" title="" >Book Name*</td>
					<td>
						<input type="text" id="username_field" name="bookname" size="30" value=""  maxlength="25" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" >Autor Name*</td>
					<td>
						<input type="text" id="username_field" name="autorname" size="30" value=""  maxlength="25" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >Editorial Name*</td>
					<td>
						<input type="text" id="username_field" name="editorialname" size="30" value=""  maxlength="25" /> 					</td>
				</tr>
                <tr>
      <td class="key" title="" >
      
		<label for="date">Publication Date*               </label> </td>
        <td>
       ...
       <td class="key" title="" >
        ...
        <td>
					...
					<td>
						<input type="text" id="audio_field" name="genero" size="30" value=""  maxlength="32" /> 					</td>
				</tr>
                <tr>
					<td class="key" title="" >
					...
					<td>
						<input name="isbn" type="number"  class="required" id="company_field" max="99999999999999" min="0" value="" /> 					</td>
				</tr>
					<tr>
					<td class="key" title="" >
						<label class="middle_name" for="middle_name_field">
					...
					<td>
						<input name="pages" type="number" id="middle_name_field" min="0" value="" size="10"  maxlength="32" /> 					</td>
				</tr>	
