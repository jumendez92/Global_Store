...
<title>Global Store - Register Language</title>
...
<br />
<h2>Register Language</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registroidio.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Language*</label></td>
					<td>
