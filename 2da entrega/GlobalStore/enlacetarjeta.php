...
<br />
<h2>Select Card</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="modificartarje.php">
			...
			<div align="center">
              ...
              <table  class="adminForm user-details">
					...
					<tr>
					<td class="key" title="" ><label for="name_field" class="name">Card*</label></td>
					<td>
                <?php include ("conexion.php");
				$result = pg_query($conexion , "select digitos_tarjeta from TARJETA" );
			?>
                	<select name="tarjeta"  >
