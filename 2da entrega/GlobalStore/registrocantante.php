...
<title>Global Store - Register Cantante</title>
...
<br />
<h2>Register Singer</h2>
<form method="post" id="adminForm" name="userForm"  class="form-validate" action="registrosinger.php">
