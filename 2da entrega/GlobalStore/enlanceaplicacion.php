...
<form method="post" id="adminForm" name="userForm"  class="form-validate">
		...
		<p>
		  <label>Before filing the application but the developer knows click <a href="/GlobalStore/registroempresapersona.php"> here<br />
		  </a></label>
		</p>
        <p>
		  <label>if you know the developer click here<a href="/GlobalStore/registroaplicacion.php"> here<br />
		  </a></label>
		</p>
              <p>
